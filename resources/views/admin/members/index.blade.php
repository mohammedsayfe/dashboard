...
@section('content')
    <div class="col-12 py-2 px-3 row">
        <h1 class="m-2 px-2 bold">
            ...
            <a href="{{ route('admin.members.details') }}" class="btn btn-info text-white" style="float: left" >تفاصيل الاعضاء</a>
        </h1>
            ...
            <table class="table table-bordered table-striped">
                ...
                @foreach($data as $member)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('admin.members.delete',$member) }}" class="btn btn-danger"><i class="fal fa-trash"></i></a>

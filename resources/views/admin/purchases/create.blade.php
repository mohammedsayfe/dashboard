...
@section('content')
<form id="validate-form" method="POST" action="{{ route('admin.purchase.store') }}" class="row" enctype="multipart/form-data">
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 main-box">
		<div class="col-12 px-0">
			<div class="col-12 px-3 py-3">
			 	<span class="fal fa-info-circle"></span>	إضافة امر شراء جديد
			</div>
...
<div class="col-12 py-2 px-3 row main-box mt-1">
    <div class="col-12 px-0">
        <div class="col-12 px-3 py-3">
            ...
            تفاصيل المشتريات - المنتجات
            <button type="button" onclick="add_product()" class="btn btn-info text-white" style="float: left" >إضافة منتج</button>
        </div>
        <div class="col-12 divider" style="min-height: 2px;"></div>
    </div>

        ...
        <div class="col-12 col-lg-12 p-0 main-box">
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-3 py-3">
                    <span class="fal fa-info-circle"></span>	تعديل حساب جديد
                </div>
                <div class="col-12 divider" style="min-height: 2px"></div>
            </div>
            <form id="validate-form" method="POST" action="{{ route('admin.account.update', $account->id) }}" class="row" enctype="multipart/form-data">
                @csrf
                <div class="col-12 col-lg-12 p-3">
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="number" name="number" required value="{{$account->account_number}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        <div class="col-12">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">  اسم البنك
                                </label>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="number" name="balance" required value="{{$account->balance}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="branch" required value="{{$account->branch}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="statement" required value="{{$account->statement}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>

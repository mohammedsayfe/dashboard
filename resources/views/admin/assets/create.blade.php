	...
	<div class="col-12 col-lg-12 p-0 main-box">
		...
		<div class="col-12 px-0">
			<div class="col-12 px-3 py-3">
			 	<span class="fal fa-info-circle"></span>	إضافة اصل جديد
			</div>
			<div class="col-12 divider" style="min-height: 2px;"></div>
		</div>
		<form id="validate-form" method="POST" action="{{ route('admin.assest.store') }}" class="row" enctype="multipart/form-data">
		    @csrf
            <div class="col-12 col-lg-12 p-3">
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="description" required minlength="3" maxlength="190" class="form-control"  >
                    </div>
                </div>

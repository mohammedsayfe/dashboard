...
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 main-box">
		...
		<form id="validate-form" method="POST" action="{{ route('admin.expens.store') }}" class="row" enctype="multipart/form-data">
		    @csrf
            <div class="col-12 col-lg-12 p-3">
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="date" name="date" required  maxlength="190" class="form-control"  >
                    </div>
                </div>
{{--                <div class="col-12 p-2">--
{{--                    <div class="col-12">--}}

	...
	<div class="col-12 col-lg-12 p-0 main-box">
		...
		<div class="col-12 px-0">
			<div class="col-12 px-3 py-3">
			 	<span class="fal fa-info-circle"></span>	إضافة بنك جديد
			</div>
			<div class="col-12 divider" style="min-height: 2px;"></div>
		</div>
		<form id="validate-form" method="POST" action="{{ route('admin.bank.store') }}" class="row" enctype="multipart/form-data">
		    @csrf

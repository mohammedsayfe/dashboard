        ...
        <div class="col-12 col-lg-12 p-0 main-box">
            <div class="col-12 px-0">
                ...
                <div class="col-12 px-3 py-3">
                    <span class="fal fa-info-circle"></span>	تعديل بيانات البنك
                </div>
                <div class="col-12 divider" style="min-height: 2px;"></div>
            </div>
            <form id="validate-form" method="POST" action="{{ route('admin.bank.update', $bank->id) }}" class="row" enctype="multipart/form-data">
                @csrf
                <div class="col-12 col-lg-12 p-3">
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="name" required value="{{$bank->name}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="address" required value="{{$bank->address}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="description" required value="{{$bank->description}}" maxlength="190" class="form-control"  >
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-3">
                        <button class="btn btn-success" id="submitEvaluation">تحديث</button>
                    </div>
            </form>
        </div>
    </div>

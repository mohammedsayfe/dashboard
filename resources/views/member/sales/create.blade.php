...
@section('content')
<form id="validate-form" method="POST" action="{{ route('member.sales.store') }}" class="row" enctype="multipart/form-data">
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 main-box">
		<div class="col-12 px-0">
			<div class="col-12 px-3 py-3">
			 	<span class="fal fa-info-circle"></span>	إضافة مبيعات جديد
			</div>
